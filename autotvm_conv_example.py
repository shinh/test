...
def tune_and_evaluate(tuning_opt):
    ...
    print("Extract tasks...")
    net, params, input_shape, out_shape = get_network(network, batch_size=32)
    print(net)
    tasks = autotvm.task.extract_from_graph(net, target=target,
                                            shape={'Input_0': input_shape}, dtype=dtype,
    ...
    with autotvm.apply_history_best('b32.log'):
    #with autotvm.apply_history_best('onnx.log'):
    #if True:
        print("Compile...")
        with nnvm.compiler.build_config(opt_level=3):
            graph, lib, params = nnvm.compiler.build(
                net, target=target, shape={'Input_0': input_shape}, params=params, dtype=dtype)
    ...
    module.set_input('Input_0', data_tvm)
